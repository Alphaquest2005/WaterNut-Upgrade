namespace SalesDataQS.Business.Entities.Mapping
{
    ...
    public partial class AsycudaDocumentSetEntryDataDetailsMap : EntityTypeConfiguration<AsycudaDocumentSetEntryDataDetails>
    {
        ...
        {                        
              ...
              this.HasRequired(t => t.SalesDataDetail).WithMany(t =>(ICollection<AsycudaDocumentSetEntryDataDetails>) t.AsycudaDocumentSetEntryDataDetails).HasForeignKey(d => d.EntryDataDetailsId);
             // Tracking Properties
